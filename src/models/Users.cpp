...
const std::string Users::Cols::_surname = "\"surname\"";
...
{"surname","std::string","character varying",30,0,0,0},
...
const std::string &Users::getValueOfSurname() const noexcept
{
    static const std::string defaultValue = std::string();
    if(surname_)
        return *surname_;
...
const std::shared_ptr<std::string> &Users::getSurname() const noexcept
{
    return surname_;
}
void Users::setSurname(const std::string &pSurname) noexcept
{
    surname_ = std::make_shared<std::string>(pSurname);
    dirtyFlag_[2] = true;
}
void Users::setSurname(std::string &&pSurname) noexcept
{
    surname_ = std::make_shared<std::string>(std::move(pSurname));
    dirtyFlag_[2] = true;
}
void Users::setSurnameToNull() noexcept
{
    surname_.reset();
    dirtyFlag_[2] = true;
}
