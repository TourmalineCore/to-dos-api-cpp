...
С компилятором повторилась похожая логика. MSVC (Microsoft Visual C++) отпал почти сразу, поскольку, как и в случае с vcpkg, не хотелось привязываться к конкретной платформе или IDE, а MSVC по сути жёстко связан с экосистемой Windows и Visual Studio.
...
С целью улучшения опыта разработки, в шаблон был добавлен Makefile. 
